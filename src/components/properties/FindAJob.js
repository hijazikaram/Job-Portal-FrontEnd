...
class FindAJob extends Component {
  ...
  validateField(fieldName, value) {
    ...
    switch(fieldName) {
      case 'name':
        ...
        fieldValidationErrors.Name = userNameValid ? '' : ' is required';
        break;
      case 'email':
  ...
  validateForm() {
    this.setState({ formValid: this.state.userNameValid && this.state.emailValid && this.state.passwordValid && this.state.confirmPasswordValid && this.state.phoneNumberValid && this.state.checkedValid });
  }
  ...
  render() {
    ...
    var registerUser = this.onRegisterUser.bind(this);
