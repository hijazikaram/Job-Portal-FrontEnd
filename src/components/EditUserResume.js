            ...
            <form action="#">
              <fieldset>
                ...
                <div className="section career-objective">
                  ...
                  <span>{this.state.characters_left}
                ...
                <div className="section">
                  ...
                  {
                    this.state.work_history.length > 0
                      ? (this.state.work_history.map(function(history, key) {
                        return (<div key={key}>
                          <div className="row form-group">
                  ...
                  <div className="row form-group time-period">
                    <label className="col-sm-3 label-title">Time Period</label>
                    <div className="col-sm-9">
                      <input type="text" name="name" className="form-control" placeholder="dd/mm/yy" onChange={addWorkHistoryTimeStartChange} value={this.state.history_time_start}/>
                      <span>-</span>
                ...
                <div className="section education-background">
                  ...
                  {
                    this.state.education_background.length > 0
                      ? (this.state.education_background.map(function(education, key) {
                        return (<div key={key}>
                          <div className="row form-group">
                  ...
                  <div className="row form-group time-period">
                    <label className="col-sm-3 label-title">Time Period</label>
                    <div className="col-sm-9">
                      <input type="text" name="name" className="form-control" placeholder="dd/mm/yy" onChange={addStartDate} value={this.state.education_time_start}/>
                      <span>-</span>
                ...
                <div className="section language-proficiency">
                  ...
                  {
                    this.state.language_proficiency.length > 0
                      ? (this.state.language_proficiency.map(function(language, key) {
                        return (<div key={key}>
                          <div className="row form-group">
                    ...
                    <div className="col-sm-9">
                      <div className="rating-star">
                        <div className="rating">
                          <input type="radio" id="star1" name="rating" onChange={addRating} checked={this.state.language_rating === 5}/>
                          <label className="full" htmlFor="star1"></label>

                          <input type="radio" id="star2" name="rating" onChange={addRating} checked={this.state.language_rating === 4.5}/>
                          <label className="half" htmlFor="star2"></label>

                          <input type="radio" id="star3" name="rating" onChange={addRating} checked={this.state.language_rating === 4}/>
                          <label className="full" htmlFor="star3"></label>

                          <input type="radio" id="star4" name="rating" onChange={addRating} checked={this.state.language_rating === 3.5}/>
                          <label className="half" htmlFor="star4"></label>

                          <input type="radio" id="star5" name="rating" onChange={addRating} checked={this.state.language_rating === 3}/>
                          <label className="full" htmlFor="star5"></label>

                          <input type="radio" id="star6" name="rating" onChange={addRating} checked={this.state.language_rating === 2.5}/>
                          <label className="half" htmlFor="star6"></label>

                          <input type="radio" id="star7" name="rating" onChange={addRating} checked={this.state.language_rating === 2}/>
                          <label className="full" htmlFor="star7"></label>

                          <input type="radio" id="star8" name="rating" onChange={addRating} checked={this.state.language_rating === 1.5}/>
                          <label className="half" htmlFor="star8"></label>

                          <input type="radio" id="star9" name="rating" onChange={addRating} checked={this.state.language_rating === 1}/>
                          <label className="full" htmlFor="star9"></label>

                          <input type="radio" id="star10" name="rating" onChange={addRating} checked={this.state.language_rating === 0.5}/>
                          <label className="half" htmlFor="star10"></label>
                        </div>
                      </div>
                    </div>
                  </div>
